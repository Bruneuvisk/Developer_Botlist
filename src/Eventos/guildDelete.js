...
module.exports = async (client, guild) => {
    ...
    const server = await client.database.servidores.findOne({
      ...
      let embedentrou = new MessageEmbed()
        .setTitle(`${emojis.developer} **Servidor Removido!** ${emojis.developer}`)
      ...
      let canalEnviar = client.guilds.cache.get('525178633707323393').channels.cache.get('895515818648018954')
